...
if(isset($_REQUEST['accio']) && $_REQUEST['accio'] == 'buscar_partida'){
  ...
  <?php
    ...
    while( $reg=mysqli_fetch_array($result)){
      ?>
      <span>Partida <?php echo $reg['id_partida'] ?> creada el <?php echo $reg['data'] ?> per  <?php echo $reg['nom_jugador1']?> </span>
      <a href="index.php?accio=connectar_a_partida&jugador2=<?php echo $_REQUEST['jugador2']?>&partida=<?php echo $reg['id_partida']?>">Connectar a partida</a><br><?php
    }
    ?>
    <script>
      setTimeout(() => {
